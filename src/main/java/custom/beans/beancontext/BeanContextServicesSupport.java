...
package custom.beans.beancontext;

import custom.beans.beancontext.BeanContext;
import custom.beans.beancontext.BeanContextChild;
import custom.beans.beancontext.BeanContextServiceAvailableEvent;
import custom.beans.beancontext.BeanContextServiceProvider;
import custom.beans.beancontext.BeanContextServiceRevokedEvent;
import custom.beans.beancontext.BeanContextServiceRevokedListener;
import custom.beans.beancontext.BeanContextServices;
import custom.beans.beancontext.BeanContextServicesListener;
import custom.beans.beancontext.BeanContextServicesSupport;
import custom.beans.beancontext.BeanContextSupport;
...
public class BeanContextServicesSupport extends BeanContextSupport implements
     ...
     * (non-Javadoc)
     * 
     * @see custom.beans.beancontext.BeanContextServices#addBeanContextServicesListener(custom.beans.beancontext.BeanContextServicesListener)
     */
     ...
     * </p>
     * 
     * @see custom.beans.beancontext.BeanContextServices#addService(java.lang.Class,
     *      custom.beans.beancontext.BeanContextServiceProvider)
     */
     ...
     * </p>
     * 
     * @see custom.beans.beancontext.BeanContextSupport#bcsPreDeserializationHook(java.io.ObjectInputStream)
     */
     ...
     * </p>
     * 
     * @see custom.beans.beancontext.BeanContextSupport#bcsPreSerializationHook(java.io.ObjectOutputStream)
     */
     ...
     * </p>
     * 
     * @see custom.beans.beancontext.BeanContextSupport#childJustRemovedHook(java.lang.Object,
     *      custom.beans.beancontext.BeanContextSupport.BCSChild)
     */
     ...
     * 
     * @see custom.beans.beancontext.BeanContextSupport#createBCSChild(java.lang.Object,
     *      java.lang.Object)
     */
     ...
     * @see custom.beans.beancontext.BeanContextServices#getCurrentServiceClasses()
     */
     ...
     * 
     * @see custom.beans.beancontext.BeanContextServices#getCurrentServiceSelectors(java.lang.Class)
     */
     ...
     * @throws TooManyListenersException
     * @see custom.beans.beancontext.BeanContextServices#getService(custom.beans.beancontext.BeanContextChild,
     *      java.lang.Object, java.lang.Class, java.lang.Object,
     *      custom.beans.beancontext.BeanContextServiceRevokedListener)
     */
     ...
     * @see custom.beans.beancontext.BeanContextServices#hasService(java.lang.Class)
     */
     ...
     * (non-Javadoc)
     * 
     * @see custom.beans.beancontext.BeanContextSupport#initialize()
     */
     ...
     * 
     * @see custom.beans.beancontext.BeanContextChildSupport#initializeBeanContextResources()
     */
     ...
     * 
     * @see custom.beans.beancontext.BeanContextChildSupport#releaseBeanContextResources()
     */
     ...
     * (non-Javadoc)
     * 
     * @see custom.beans.beancontext.BeanContextServices#removeBeanContextServicesListener(custom.beans.beancontext.BeanContextServicesListener)
     */
     ...
     * @see custom.beans.beancontext.BeanContextServices#revokeService(java.lang.Class,
     *      custom.beans.beancontext.BeanContextServiceProvider, boolean)
     */
     ...
     * 
     * @see custom.beans.beancontext.BeanContextServicesListener#serviceAvailable(custom.beans.beancontext.BeanContextServiceAvailableEvent)
     */
     ...
     * <code>BeanContextServices</code> of the event.
     * 
     * @see custom.beans.beancontext.BeanContextServiceRevokedListener#serviceRevoked(custom.beans.beancontext.BeanContextServiceRevokedEvent)
     */
    public void serviceRevoked(BeanContextServiceRevokedEvent event) {
        if (null == event) {
            throw new NullPointerException(Messages.getString("beans.1C")); //$NON-NLS-1$
